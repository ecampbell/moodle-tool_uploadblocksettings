...
/**
 * Main form for uploading course block settings.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class uploadblocksettings_form extends moodleform {
    ...
    public function validation($data, $files) {
        ...
        if (empty($data['csvfile'])) {
            $errors['csvfile'] = get_string('uploadcsvfilerequired', 'tool_uploadblocksettings');
        }
